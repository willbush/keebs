...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LG] = LAYOUT_planck_grid(
    _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_V, _______, _______, _______, _______, _______, _______,
    _______,    KC_5,    KC_6,    KC_7,    KC_8,    KC_V, _______, _______, _______, _______, _______,  KC_DEL,
    _______, _______, _______,    KC_9,    KC_0,    KC_V, _______, _______, _______, _______, _______, KC_RSFT,
